    ...
    <div class="card shadow border-left-primary">
        ...
        <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <p class="form-control-plaintext text-secondary">{{ $user->approval_type }}</p>
                </div>
            </div>
            <div class="row mb-3">
            ...
            <a href="/ltouser/allTaxpayers" class="btn btn-secondary">Go Back</a>
        </div>
    </div>  
</div>
@endsection